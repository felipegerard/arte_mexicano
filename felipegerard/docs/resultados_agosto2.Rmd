...
substr(corp[[2]]$content, 78775, (78775+1140))
```
...
Tamaño del `Corpus` (archivo `.Rdata`): ~ 220 MB
...
qplot(doc_freqs) + labs(x='Palabras', y='Documentos', title='Histograma del número de palabras en la colección limpia')
```
...
library(wordcloud)
set.seed(1234)
wordcloud(words$word, words$freq, min.freq = 40000)
```
